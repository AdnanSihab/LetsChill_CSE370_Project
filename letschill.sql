...
insert into role_table (Job) values
('admin'),
('organizer'),
('performer'),
('buyer');
...
insert into concert (Name, Date, type, description, organizer_nid, location_id)
values
('Concert 1', '2024-05-10', 'Rock', 'Rock concert featuring Jon Kabir', '8765432101234567', 1),
('Concert 2', '2024-06-15', 'Pop', 'Pop concert featuring Tahsan', '8765432101234567', 2);


insert into tickets (Type, price, total_tickets, buyer_nid, concert_id)
values
('VIP', 100, 100, '7654321012345678', 1),
('Regular', 50, 200, '7654321012345678', 1),
('Regular', 50, 200, '7654321012345678', 1),
('Regular', 50, 200, '7654321012345678', 1),
('Regular', 50, 200, '7654321012345678', 1),
('Regular', 50, 200, '7654321012345678', 1),
